...
function seedMeds() {
  if (!localStorage.getItem('medicat')) {
    const sampleMeds =[  
      ...
      { title: "Aspirin", total: 40, category: "Painkiller", img: "aspirin.jpg" },
      { title: "Zinc Tablets", total: 60, category: "Supplement", img: "zinc.jpg" },
      { title: "Allergy Pills", total: 90, category: "Allergy", img: "allergy.jpg" },
      { title: "Cold Relief", total: 55, category: "Flu", img: "cold.jpg" },
      { title: "Multivitamin", total: 120, category: "Supplement", img: "multi.jpg" },
      { title: "Ibuprofen", total: 45, category: "Painkiller", img: "ibuprofen.jpg" },
      { title: "Paracetamol", total: 35, category: "Painkiller", img: "para.jpg" },
      { title: "Calcium Tablets", total: 80, category: "Supplement", img: "calcium.jpg" },
      { title: "Magnesium", total: 70, category: "Supplement", img: "magnesium.jpg" },
      { title: "Nasal Spray", total: 65, category: "Flu", img: "nasal.jpg" },
      { title: "Cough Lozenges", total: 25, category: "Flu", img: "lozenge.jpg" },
      { title: "Iron Tablets", total: 85, category: "Supplement", img: "iron.jpg" },
      { title: "Omega 3", total: 150, category: "Supplement", img: "omega.jpg" },
      { title: "Antibiotic Cream", total: 95, category: "Topical", img: "cream.jpg" },
      { title: "Eye Drops", total: 50, category: "Eye Care", img: "eyedrops.jpg" }
  ];
